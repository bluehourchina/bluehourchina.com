...
const locales = {
  en: {
    ...
    processTitle: "A private journey begins with three clear steps",
    process: [
      ["01", "Choose a starting route", "Use the public itinerary to understand the pace, price level and places."],
      ["02", "Send dates and group details", "Tell us the month, travellers, days, budget and what comfort means to you."],
      ["03", "Receive a route and starting quote", "A human planner replies within one business day with the fit, changes and next questions."],
    ],
    careEyebrow: "Why Bluehour China",
    careTitle: "The comfort is in what gets handled",
    careIntro: "Deeper China becomes easier when language, transfers, rooms and timing are settled before they become problems.",
    care: [
      ["One planner", "One person follows the brief from first reply to local handoff."],
      ["Language bridge", "Chinese coordination and clear contact options for international travellers."],
      ["Visible costs", "Days, starting price and private-group minimum are shown before inquiry."],
      ["Local delivery", "Suitable local providers confirm bookings and on-trip services in the final arrangement."],
    ],
    ...
    formIntro: "Seven short answers are enough. We reply with a route direction, a starting quote and the questions needed to make it real.",
  ...
  zh: {
    ...
    routesEyebrow: "標準私人方案", routesTitle: ["先選一條看得懂的路線", "再為同行的人調整"],
    ...
    processEyebrow: "如何開始", processTitle: ["三個步驟", "把想法整理成可報價路線"],
    process: [["01", "先選標準路線", "看懂每天怎麼走、價格在哪一層、哪些地方最值得留下。"], ["02", "留下日期與同行資訊", "告訴我們月份、人數、天數、預算與舒適需求。"], ["03", "收到路線方向與起價", "人工旅策會在 1 個工作日內回覆適配度、調整建議與下一步。"]],
    careEyebrow: "為什麼是若青中國旅策", careTitle: ["真正的舒適", "是麻煩有人先處理"], careIntro: "深入中國的難度常在語言、移動、房間與時間。這些細節要在出發前變得清楚。",
    care: [["同一位旅策", "從第一次回覆到交接當地服務，由同一條溝通線承接。"], ["語言橋接", "協助中文確認，也尊重外國旅人習慣的聯絡方式。"], ["價格透明", "諮詢前先看天數、起價與最低成行人數。"], ["當地承接", "需求確認後，由適合的當地服務商完成正式預訂與旅途服務。"]],
    ...
    formEyebrow: "私人路線需求", formTitle: ["告訴我們", "你想怎麼感受中國"], formIntro: "七個簡短答案就夠。你會收到路線方向、起價與正式規劃前需要確認的問題。", responseNote: "1 個工作日內人工回覆",
  ...
  ja: {
    ...
    processEyebrow: "ご相談の流れ", processTitle: ["三つのステップで", "旅を具体的にします"], process: [["01", "モデルルートを選ぶ", "毎日の流れ、料金の目安、訪れる場所を確認します。"], ["02", "日程と人数を送る", "旅行月、人数、日数、予算、快適さを教えてください。"], ["03", "ルートと見積り目安を受け取る", "担当者が1営業日以内に適合性と調整点をご連絡します。"]],
    careEyebrow: "Bluehour Chinaを選ぶ理由", careTitle: ["快適さは", "細部が整っていること"], careIntro: "言葉、移動、部屋、時間を出発前に整えることで、中国の奥へ無理なく入れます。", care: [["一人の担当者", "最初の相談から現地への引き継ぎまで同じ線で進みます。"], ["言葉の橋", "中国語での確認と海外ゲスト向け連絡を整えます。"], ["見える料金", "相談前に日数、料金目安、最少人数を確認できます。"], ["現地手配", "確定後は適切な現地事業者が予約と現地サービスを担当します。"]],
  ...
  ko: {
    ...
    processEyebrow: "진행 방식", processTitle: ["세 단계로", "여행을 구체화합니다"], process: [["01", "표준 루트 선택", "매일의 흐름, 가격대와 방문 지역을 확인합니다."], ["02", "날짜와 인원 전달", "여행 월, 인원, 일수, 예산, 편안함을 알려 주세요."], ["03", "루트와 시작 견적 수신", "담당자가 1영업일 이내에 적합성과 조정점을 답변합니다."]],
    careEyebrow: "Bluehour China의 방식", careTitle: ["편안함은", "세부가 정리되어 있다는 것"], careIntro: "언어, 이동, 객실, 시간을 출발 전에 정리해 중국의 더 깊은 곳으로 편하게 갑니다.", care: [["한 명의 담당자", "첫 문의부터 현지 인계까지 같은 소통선이 이어집니다."], ["언어 연결", "중국어 현지 확인과 해외 여행자용 연락을 정리합니다."], ["보이는 비용", "상담 전 일수, 시작가, 최소 인원을 확인할 수 있습니다."], ["현지 진행", "확정 후 적합한 현지 사업자가 예약과 현지 서비스를 담당합니다."]],
  ...
  th: {
    ...
    processEyebrow: "วิธีเริ่ม", processTitle: "สามขั้นตอนสู่ทริปส่วนตัว", process: [["01", "เลือกเส้นทางตัวอย่าง", "ดูจังหวะ ราคา และพื้นที่ที่อยากไป"], ["02", "ส่งวันและข้อมูลกลุ่ม", "บอกเดือน จำนวนวัน งบ และความสบายที่ต้องการ"], ["03", "รับเส้นทางและราคาเริ่มต้น", "ผู้วางแผนตอบภายใน 1 วันทำการพร้อมข้อเสนอปรับเส้นทาง"]],
    careEyebrow: "ทำไม Bluehour China", careTitle: "ความสบายอยู่ในรายละเอียดที่มีคนดูแล", careIntro: "ภาษา รถ ห้องพัก และเวลาควรถูกจัดการก่อนจะกลายเป็นปัญหา", care: [["ผู้ดูแลคนเดียว", "ติดตามตั้งแต่ข้อความแรกจนส่งต่อผู้ให้บริการท้องถิ่น"], ["สะพานภาษา", "ประสานภาษาจีนและช่องทางติดต่อที่นักเดินทางต่างชาติใช้"], ["ราคาเห็นได้", "เห็นวัน ราคาเริ่มต้น และจำนวนขั้นต่ำก่อนส่งคำขอ"], ["บริการท้องถิ่น", "ผู้ให้บริการที่เหมาะสมยืนยันการจองและบริการจริงหลังตกลง"]],
...
function innerPage(lang, locale) {
  ...
  const descriptions = { en: "A 6-day private Inner Mongolia route through Hohhot, Huitengxile grassland, Kubuqi Desert and Ordos, with public starting prices for 2, 4 and 6 travellers.", zh: "6 天 5 晚內蒙古私人路線，串起呼和浩特、輝騰錫勒草原、庫布齊沙漠與鄂爾多斯，公開 2、4、6 人參考起價。", ja: "フフホト、フイトンシレ草原、クブチ砂漠、オルドスを巡る6日間の内モンゴル個別ルート。2名様からの料金目安も公開しています。", ko: "후허하오터, 후이텅시러 초원, 쿠부치 사막, 오르도스를 잇는 6일 내몽골 개인 루트입니다.", th: "เส้นทางส่วนตัว 6 วันในมองโกเลียใน ผ่านฮูฮอต ทุ่งหญ้าฮุยเถิงซีเล่อ ทะเลทรายคูปู้ฉี และออร์ดอส" };
  ...
  const tiers = { en: [["2 travellers", "US$1,190 pp"], ["4 travellers", "US$990 pp"], ["6 travellers", "US$850 pp"]], zh: [["2 人", "RMB 8,600/人"], ["4 人", "RMB 7,200/人"], ["6 人", "RMB 6,150/人"]], ja: [["2名", "JPY 190,000/名"], ["4名", "JPY 158,000/名"], ["6名", "JPY 136,000/名"]], ko: [["2명", "KRW 1,650,000/인"], ["4명", "KRW 1,370,000/인"], ["6명", "KRW 1,180,000/인"]], th: [["2 ท่าน", "THB 39,000/ท่าน"], ["4 ท่าน", "THB 32,500/ท่าน"], ["6 ท่าน", "THB 28,000/ท่าน"]] };
  ...
  const low = tiers[lang][2][1].replace(/[^0-9,]/g, "").replaceAll(",", "");
