...
const destinations = {
  yunnan: {
    ...
    en: {
      ...
      note: "Price excludes international flights and may change with season, hotel level, group size, vehicle needs and current room, vehicle and ticket availability.",
    ...
    zh: {
      ...
      note: "價格不含國際機票；正式價格依季節、住宿級別、人數與車輛需求確認。",
      cta: "詢問這條路線",
      tags: ["湖光", "古鎮", "雪山"],
    },
    ja: {
      ...
      note: "国際航空券は含みません。正式料金は季節、宿泊水準、人数、車両、客室、車両、チケットの空き状況により変わります。",
      cta: "このルートを相談する",
      tags: ["湖", "古鎮", "雪山"],
    },
    ko: {
      ...
      note: "국제선 항공권은 포함되지 않습니다. 최종 가격은 계절, 숙소 등급, 인원, 차량, 객실, 차량, 티켓 가능 여부에 따라 달라집니다.",
      cta: "이 루트 상담하기",
      tags: ["호수", "옛 마을", "설산"],
    },
    th: {
      ...
      note: "ไม่รวมตั๋วเครื่องบินระหว่างประเทศ ราคาจริงขึ้นอยู่กับฤดูกาล ระดับที่พัก จำนวนคน รถ และทีมบริการในพื้นที่",
