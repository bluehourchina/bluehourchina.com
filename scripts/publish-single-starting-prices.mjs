...
for (const file of ["llms.txt", "llms-full.txt"]) {
  updated += await updateFile(file, (text) => text
    ...
    .replace(/Extended public product: Grand Yunnan Loop,[\s\S]*?Final quote depends on season, hotel level, room configuration, exact tickets, vehicle needs and current room, vehicle and ticket availability\./g, "Extended public product: Grand Yunnan Loop, 13 days and 12 nights, Dali · Lijiang · Xishuangbanna · Tengchong · Mangshi. The only public price is from US$1,250 per traveller based on 6 travellers, or about NT$40,000 per traveller on the Traditional Chinese page. International flights are excluded. Prices for 2 or 4 travellers are provided after inquiry. Final quote depends on season, hotel level, room configuration, exact tickets, vehicle needs and current room, vehicle and ticket availability.")
