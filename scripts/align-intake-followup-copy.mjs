...
const copy = {
  en: {
    ...
    proof: [
      ...
      ["Route note", "Starting quote", "Human reply", "Local matching"],
    ],
  ...
  th: {
    ...
    proof: [
      ...
      ["บันทึกเส้นทาง", "ราคาเริ่มต้น", "คนจริงตอบ", "จับคู่ในพื้นที่"],
    ],
...
const globalReplacements = [
  ...
  ["若青中國旅策會回覆一個不催促、但可執行的第一方向。", "若青中國旅策會回覆一份路線遊記式建議、初步方案報價與下一輪確認問題"],
  ...
  ["then replies with a calm first direction", "then replies with a route note, a starting quote and follow-up questions"],
  ["replies with a calm first direction before matching local providers when appropriate.", "replies with a travel-journal style route note, a starting quote and follow-up questions before matching local providers when appropriate."],
];
