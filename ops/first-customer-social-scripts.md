# First Customer Social Scripts

Use these scripts for the first acquisition week. The goal is one qualified consultation, not general brand awareness.
...
Voiceover:
雲南最容易排錯的地方，不是景點不夠，而是每天都在換城市。大理需要清晨，沙溪需要夜晚，麗江或白沙適合把雪山放遠一點。
...
Voiceover:
大理留給風和湖。沙溪留給夜。麗江或白沙留給雪山遠景。一週時間，不要急著佔有每個地方。
...
Voiceover:
真正有價值的是少出錯。車程不要太緊，住宿不要離古鎮太遠，同行者累的時候有人能調整，語言和入住先被確認好。
...
Voiceover:
旅行不是一個人說了算。先確認你們想要的風景、能接受的車程、住宿感和預算感，再決定要不要走一條慢一點的路。
...
Voiceover:
大團適合省心，自由行適合很會查資料的人。私旅適合你想要舒服，但不想每天自己處理車、房、語言和臨時變化。
...
If they only say "interested":
可以。先問你 4 個問題：大概什麼月份、幾位同行、想走一週還是一週多一點、預算感比較接近 RMB 8,800/人起還是更重視住宿舒適？你也可以直接填表，比較不會漏。

## First Reply After Form

您好，謝謝你留下旅行條件。我們會先看季節、人數、天數、預算感與同行者狀態，回覆一份初步路線、起價範圍，以及下一輪需要確認的問題。這不是制式行程，會先判斷這條雲南慢路線是否真的適合你們。
