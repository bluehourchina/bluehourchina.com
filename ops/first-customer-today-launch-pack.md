# First Customer Today Launch Pack
...
- 1 short video published on Instagram Reels, TikTok and YouTube Shorts
- 1 pinned comment under each video
- 20 warm direct shares or DMs sent
- 5 public comments or replies posted in relevant travel discussions where allowed
- 10 website clicks
- 1 form submission or at least 1 warm DM asking about month, price or route
...
雲南最容易排錯的地方，不是景點不夠，而是每天都在換城市。大理需要清晨，沙溪需要夜晚，麗江或白沙適合把雪山放遠一點。真正舒服的一週，是讓每個地方都有自己的時間。
...
- 0-3s: lake or road opening, calm and cinematic
- 3-7s: old town / stone road
- 7-11s: room, courtyard or warm light
- 11-15s: mountain, car window or walking back view
...
Use only where self-promotion is allowed or where someone is asking about China/Yunnan planning.
...
- Send DM to anyone who asked about price, route, days or family travel.
- Post one story with the route shape again.
...
您好，謝謝你留下旅行條件。我先用目前資訊判斷：雲南一週慢路線通常會把大理、沙溪、麗江或白沙分成不同節奏，不會每天換城市。

我接下來會先回你三件事：

1. 這條路線是否適合你們的人數與季節
2. 大概起價範圍與可能影響價格的地方
3. 下一輪要確認的住宿、車程與同行者需求

我需要再確認：你們比較重視住宿舒適、拍照風景，還是少走路少折騰？
